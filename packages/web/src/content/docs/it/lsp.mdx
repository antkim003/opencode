---
title: Server LSP
description: Weave si integra con i tuoi server LSP.
---

Weave si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

Weave include diversi server LSP integrati per linguaggi popolari:
