---
title: Zen
description: Lista curata di modelli fornita da Weave.
---
...
Weave Zen è una lista di modelli testati e verificati dal team di Weave.

:::note
Weave Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in Weave. Accedi a Weave Zen e ottieni la tua chiave API. È **completamente opzionale** e non devi usarlo per usare Weave.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Weave.
:::
...
Weave Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Weave Zen funziona come qualunque altro provider in Weave.

1. Accedi a **<a href={console}>Weave Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Weave Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Weave usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti `opencode/gpt-5.3-codex` nella config.
...
- MiniMax M2.5 Free è disponibile su Weave per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiMo V2 Flash Free è disponibile su Weave per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Weave per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su Weave per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Weave.
