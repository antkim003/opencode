...
Le skill degli agenti permettono a Weave di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Weave cerca in queste posizioni:
...
Per i percorsi locali al progetto, Weave risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Weave elenca le skill disponibili nella descrizione dello strumento `skill`.
