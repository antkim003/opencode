...
Con Weave puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, Weave usa il tema `opencode`.
...
Weave include diversi temi integrati.
...
- Vuole che Weave corrisponda all'aspetto del terminale
...
Weave supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
