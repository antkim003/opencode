---
title: Share
description: Share your Weave conversations.
---

Weave's share feature allows you to create public links to your Weave conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Weave:
...
Weave supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Weave uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
