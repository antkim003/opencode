---
title: خوادم LSP
description: يتكامل Weave مع خوادم LSP لديك.
---

يتكامل Weave مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Weave مع عدة خوادم LSP مدمجة للغات الشائعة:
