...
You can add custom commands through the Weave config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Weave [config](/docs/config):
