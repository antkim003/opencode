---
title: TUI
description: Using the Weave terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weave provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Weave starts the TUI for the current directory.
...
When using the Weave TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Weave. Allows you to select from available providers and add their API keys.
