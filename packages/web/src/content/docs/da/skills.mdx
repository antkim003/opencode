...
Agentferdigheter lar Weave oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Weave søker etter disse stedene:
...
For prosjektlokale stier går Weave opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Weave viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
