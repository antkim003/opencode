---
title: Deling
description: Del dine Weave-samtaler.
---

Weaves delingsfunksjon lar deg lage offentlige lenker til dine Weave-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Weave støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Weave manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
