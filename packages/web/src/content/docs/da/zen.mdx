---
title: Zen
description: Udvalgt liste over modeller leveret af Weave.
---
...
Weave Zen er en liste over testede og verificerede modeller leveret af Weave-teamet.

:::note
Weave Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Weave. Du logger på Weave Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Weave.
:::
...
Weave Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Weave Zen fungerer som alle andre udbydere i Weave.

1. Du logger på **<a href={console}>Weave Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Weave Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i Weave-konfigurationen
...
- MiniMax M2.5 Gratis er tilgængelig på Weave i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Weave i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Weave også.
