---
title: TUI
description: Brug af Weave-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weave giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Weave starter TUI for den nuværende mappe.
...
Når du bruger Weave TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Weave. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
