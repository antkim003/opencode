...
Med Weave kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Weave vårt eget `opencode`-tema.
...
Weave kommer med flere innebygde temaer.
...
- Vil at Weave skal matche terminalens utseende
...
Weave støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
