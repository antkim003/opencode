---
title: LSP-servere
description: Weave integreres med dine LSP-servere.
---

Weave integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Weave leveres med flere indbyggede LSP-servere til populære sprog:
