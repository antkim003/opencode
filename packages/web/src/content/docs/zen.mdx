---
title: Zen
description: Curated list of models provided by Weave.
---
...
Weave Zen is a list of tested and verified models provided by the Weave team.

:::note
Weave Zen is currently in beta.
:::

Zen works like any other provider in Weave. You login to Weave Zen and get
...
:::tip
We tested a select group of models and providers that work well with Weave.
:::
...
Weave Zen is an AI gateway that gives you access to these models.

---

## How it works

Weave Zen works like any other provider in Weave.

1. You sign in to **<a href={console}>Weave Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Weave Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Weave config
...
- MiniMax M2.5 Free is available on Weave for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo V2 Pro Free is available on Weave for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo V2 Omni Free is available on Weave for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on Weave for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Weave for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Weave as well.
