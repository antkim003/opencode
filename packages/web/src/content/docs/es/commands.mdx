...
Puede agregar comandos personalizados a través de la configuración Weave o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Weave [config](/docs/config):
