---
title: Compartir
description: Comparte tus conversaciones Weave.
---

La función para compartir de Weave te permite crear enlaces públicos a tus conversaciones de Weave, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Weave:
...
Weave admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Weave usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
