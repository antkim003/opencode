...
Con Weave puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Weave usa nuestro propio tema `opencode`.
...
Weave viene con varios temas integrados.
...
- Quiere que Weave coincida con la apariencia de su terminal
...
Weave admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
