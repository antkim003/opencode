---
title: TUI
description: Usando la interfaz de usuario del terminal Weave.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weave proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Weave se inicia TUI para el directorio actual.
...
Cuando utilice Weave TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Weave. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
