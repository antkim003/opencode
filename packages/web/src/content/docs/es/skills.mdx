...
Las habilidades del agente permiten a Weave descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Para las rutas locales del proyecto, Weave sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Weave enumera las habilidades disponibles en la descripción de la herramienta `skill`.
