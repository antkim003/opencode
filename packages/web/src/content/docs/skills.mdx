...
Agent skills let Weave discover reusable instructions from your repo or home directory.
...
Weave searches these locations:
...
For project-local paths, Weave walks up from your current working directory until it reaches the git worktree.
...
Weave lists available skills in the `skill` tool description.
