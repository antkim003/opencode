...
With Weave you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Weave uses our own `opencode` theme.
...
Weave comes with several built-in themes.
...
- Want Weave to match their terminal's appearance
...
Weave supports a flexible JSON-based theme system that allows users to create and customize themes easily.
