---
title: LSP Server
description: Weave lässt sich in Ihren LSP-Server integrieren.
---

Weave lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

Weave verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn Weave eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Weave-Konfiguration anpassen.
