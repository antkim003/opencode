...
Mit Weave kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Weave das `opencode`-Theme.
...
Weave liefert mehrere eingebaute Themes mit.
...
- Weave optisch ans Terminal anpassen wollen
...
Weave unterstuetzt ein flexibles JSON-basiertes Theme-System.
