---
title: Zen
description: Kuratierte Modellliste direkt von Weave.
---
...
Weave Zen ist eine vom Weave-Team getestete und verifizierte Modellliste.

:::note
Weave Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Weave.
Du meldest dich bei Weave Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit Weave funktionieren.
:::
...
Weave Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

Weave Zen funktioniert wie jeder andere Provider in Weave.

1. Melde dich bei **<a href={console}>Weave Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle Weave Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Weave-Konfiguration hat das Format `opencode/<model-id>`.
...
- MiniMax M2.5 Free ist fuer begrenzte Zeit auf Weave verfuegbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das fuer begrenzte Zeit kostenlos auf Weave verfuegbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Weave Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und Weave weiter mit anderen Providern nutzen kannst
