...
Agent Skills erlauben Weave, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
Weave sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft Weave vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
Weave listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
