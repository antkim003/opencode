---
title: LSP Servers
description: Weave integrates with your LSP servers.
---

Weave integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

Weave comes with several built-in LSP servers for popular languages:
