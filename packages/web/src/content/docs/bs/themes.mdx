...
U Weave mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Weave koristi nasu `opencode` temu.
...
Weave dolazi sa vise ugradenih tema.
...
- Zele da Weave odgovara izgledu njihovog terminala
...
Weave podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
