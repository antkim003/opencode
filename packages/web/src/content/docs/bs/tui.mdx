---
title: TUI
description: Korištenje korisničkog interfejsa Weave terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Weave pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Weave pokreće TUI za trenutni direktorij.
...
Kada koristite Weave TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Weave. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Weave. _Aliases_: `/quit`, `/q`
