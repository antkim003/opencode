...
Agent skills omogucavaju Weave da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Za projektne lokalne putanje, Weave ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Weave navodi dostupne skills u opisu `skill` alata.
