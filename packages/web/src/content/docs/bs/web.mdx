---
title: Web
description: Korišćenje Weave u vašem pretraživaču.
---

Weave može raditi kao web aplikacija u vašem pretraživaču, pružajući isto moćno iskustvo AI kodiranja bez potrebe za terminalom.

![Weave Web - Nova sesija](../../../assets/web/web-homepage-new-session.png)
...
Ovo pokreće lokalni server na `127.0.0.1` sa nasumičnim dostupnim portom i automatski otvara Weave u vašem podrazumevanom pretraživaču.
...
Weave podrazumevano bira dostupni port. Možete odrediti port:
...
Podrazumevano, server se vezuje za `127.0.0.1` (samo lokalni host). Da biste Weave učinili dostupnim na vašoj mreži:

```bash
opencode web --hostname 0.0.0.0
```

Kada koristite `0.0.0.0`, Weave će prikazati i lokalne i mrežne adrese:
...
Jednom pokrenut, web sučelje pruža pristup vašim Weave sesijama.

### Sesije

Pregledajte i upravljajte svojim sesijama sa početne stranice. Možete vidjeti aktivne sesije i započeti nove.

![Weave Web - aktivna sesija](../../../assets/web/web-homepage-active-session.png)

### Status servera

Kliknite "Pogledajte servere" da vidite povezane servere i njihov status.

![Weave Web - Vidi servere](../../../assets/web/web-homepage-see-servers.png)
