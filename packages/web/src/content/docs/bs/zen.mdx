---
title: Zen
description: Kurirana lista modela koje nudi Weave.
---
...
Weave Zen je lista testiranih i provjerenih modela koje obezbjeduje Weave tim.

:::note
Weave Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u Weave. Prijavite se u Weave Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili Weave.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Weave.
:::
...
Weave Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Weave Zen radi kao i svaki drugi provajder u Weave.

1. Prijavite se na **<a href={console}>Weave Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite Weave Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u Weave konfiguraciji koristi format `opencode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `opencode/gpt-5.2-codex`.
...
- MiniMax M2.5 Free je dostupan na Weave ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
- Big Pickle je stealth model koji je besplatan na Weave ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u Weave.
