...
Vous pouvez ajouter des commandes personnalisées via la configuration Weave ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Weave [config](/docs/config) :
