...
Les compétences d'agent permettent à Weave de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Weave recherche ces emplacements :
...
Pour les chemins locaux du projet, Weave remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Weave répertorie les compétences disponibles dans la description de l'outil `skill`.
