---
title: SDK
description: Typesikker JS-klient for Weave-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Weave JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Weave programmatisk.
...
Hvis du allerede har en kjørende forekomst av Weave, kan du opprette en klientforekomst for å koble til den:
