...
Weave gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Weave starter TUI for gjeldende katalog.
...
Når du bruker Weave TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Weave. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Weave. _Aliaser_: `/quit`, `/q`
